...
contract GuitarSwapLottery is ReentrancyGuard, IGuitarSwapLottery, Ownable {
    ...
    uint256 public minPriceTicketInGuitar = 0.00005 ether;
    ...
    function getNumberTicketsPerLotteryId(uint256 lotteryId, uint32 ticketNumber) public view returns(uint256){
        return _numberTicketsPerLotteryId[lotteryId][1 + (ticketNumber % 10)];
    }
    /**
