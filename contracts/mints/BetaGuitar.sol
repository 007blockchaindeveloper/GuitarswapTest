...
contract BetaGuitar is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    address payable private _PaymentAddress = payable(0x6fbAF7a35B481Ccb71cA1b45cD9f167F7dc6236f);
    ...
    uint256 public _activeDateTime = 1642640400; //(GMT): Thursday, January 20, 2022 1:00:00 PM
    
    string private _tokenBaseURI = "";
    
    Counters.Counter private _publicGUITAR;

    constructor() ERC721("Beta Guitar", "BETAGUT") public {}
